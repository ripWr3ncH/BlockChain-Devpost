 ...
 *
 *   Regulation A        rescheduling needs approval one level above the
 ...
 *   Regulation B 6(d)   qualitative upgrades out of Sub-Standard are reserved
 *                       to the Board.
 *
...
export function requiredAuthority(
  ...
  switch (type) {
    ...
    case 'RESCHEDULE':
      ...
      // Third and fourth attempts go to the Board (Regulation A).
...
/**
 * Regulation B para 11(c) requires written justification carrying the
...
/** Regulation B: 31 March, 30 June, 30 September, 31 December. */
