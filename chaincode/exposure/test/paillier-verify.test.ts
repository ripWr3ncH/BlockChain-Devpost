...
/** Enc(520), Enc(430), Enc(290) — three banks' exposure to group G-0447, in millions. */
const CIPHERTEXTS = [
...
describe('threshold comparison happens in the clear (§3.7.2)', () => {
  it('alerts when the group total exceeds theta times system capital', () => {
    // theta = 0.10 -> 10% of 10,000 million = 1,000; total 1,240 breaches it.
  ...
  it('uses integer arithmetic, so no float rounding enters consensus', () => {
    // 0.3333 of 3 million. Floats would give 0.9999000000000001; we get 9999.
