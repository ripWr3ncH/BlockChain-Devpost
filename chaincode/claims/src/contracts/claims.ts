 ...
 *  requiring Central Authority, resolution-law and capital-market authorisation
 ...
 * the deposit protection scheme covers up to $2,00,000 per depositor per
  ...
  async TransferClaim(ctx: Context, claimId: string): Promise<void> {
    throw new Error(
      'TRANSFER_NOT_AUTHORISED: Verity asserts no existing legal authority for secondary ' +
        ...
        'require specific Central Authority, resolution-law and capital-market authorisation. ' +
