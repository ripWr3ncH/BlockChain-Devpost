...
export const ORGS: Record<string, OrgProfile> = {
  banka: {
    mspId: 'BankAMSP',
    domain: 'banka.verity.local',
    peerEndpoint: 'localhost:9051',
    peerHostAlias: 'peer0.banka.verity.local',
  },
  bankb: {
    mspId: 'BankBMSP',
    domain: 'bankb.verity.local',
    peerEndpoint: 'localhost:9061',
    peerHostAlias: 'peer0.bankb.verity.local',
  },
  bb: {
    mspId: 'CentralAuthorityMSP',
    domain: 'bb.verity.local',
    peerEndpoint: 'localhost:9071',
    peerHostAlias: 'peer0.bb.verity.local',
  },
  frc: {
    mspId: 'RegulatoryCouncilMSP',
    domain: 'frc.verity.local',
    peerEndpoint: 'localhost:9081',
    peerHostAlias: 'peer0.frc.verity.local',
  },
};
...
export const DEMO_USERS: DemoUser[] = [
  ...
  { id: 'frc-analyst', org: 'frc', role: 'frc', seniority: 4, displayName: 'Regulatory Council analyst', portal: 'supervisor' },
];
 ...
 *   run inside verity_net   peer0.banka.verity.local:9051   Docker DNS
 *
