...
if (run(2)) {
  ...
  await call('/loans', 'officer-rahim', 'POST', {
    commitmentId: fresh, initialTier: 'STANDARD', outstandingBand: '$10-50 M',
...
if (run(9)) {
  ...
  if (puppets.length === 3) {
    ...
    await call('/loans', 'officer-rahim', 'POST', {
      commitmentId: fresh, initialTier: 'STANDARD', outstandingBand: '$100-150 M',
      groupToken: 'G-0447', payloadHash: Z, originationDate: '2027-01-15',
    });
    ...
    console.log(
      `  ${C.dim}  and once Central Authority confirms them, the SAME three signatures ` +
