...
#
#    "Ordering organisations are Central Authority, two Regulatory Council
#     seats and two rotating bank seats: five nodes. Since BFT requires
...
ORDERERS=(
  "orderer0.ord-bb.verity.local:Central Authority"
  "orderer1.ord-bibm.verity.local:Regulatory Council"
  "orderer2.ord-frc.verity.local:Regulatory Council"
  "orderer3.ord-seata.verity.local:Rotating bank seat A"
  "orderer4.ord-seatb.verity.local:Rotating bank seat B"
)
...
commit() {
  ...
  body=$(jq -nc --arg l "$id" --arg z "$Z" \
    '{commitmentId:$l,initialTier:"STANDARD",outstandingBand:"$1-10 M",groupToken:"G-0447",payloadHash:$z,originationDate:"2027-02-01"}')
