...
declare -A ORG=(
  [banka]="banka.verity.local:10054:ca-banka"
  [bankb]="bankb.verity.local:10064:ca-bankb"
  [bb]="bb.verity.local:10074:ca-bb"
  [frc]="frc.verity.local:10084:ca-frc"
)
...
# ---------------------------------------------------------------------------
USERS=(
  # Bank A Islami Bank — the originating institution in Act 1
  ...
  # Bank B Bank — needed for Act 3a's two-identity privacy comparison
  ...
  # Central Authority — endorses every lifecycle event, and its reads are logged
  ...
  "frc|frc-analyst|frc|4|Regulatory Council analyst"
)
...
step "  openssl x509 -in .../users/officer-rahim@banka.verity.local/msp/signcerts/cert.pem -noout -text | grep -A2 1.2.3.4.5.6.7.8.1"
