...
declare -A ORG=(
  [banka]="BankAMSP:peer0.banka.verity.local:9051"
  [bankb]="BankBMSP:peer0.bankb.verity.local:9061"
  [bb]="CentralAuthorityMSP:peer0.bb.verity.local:9071"
  [frc]="RegulatoryCouncilMSP:peer0.frc.verity.local:9081"
)
declare -A ORG_DOMAIN=(
  [banka]=banka.verity.local
  [bankb]=bankb.verity.local
  [bb]=bb.verity.local
  [frc]=frc.verity.local
)

# Orderer index -> "domain:host:generalPort:adminPort"
ORDERERS=(
  "ord-bb.verity.local:orderer0.ord-bb.verity.local:7050:8050"
  "ord-bibm.verity.local:orderer1.ord-bibm.verity.local:7051:8051"
  "ord-frc.verity.local:orderer2.ord-frc.verity.local:7052:8052"
  "ord-seata.verity.local:orderer3.ord-seata.verity.local:7053:8053"
  "ord-seatb.verity.local:orderer4.ord-seatb.verity.local:7054:8054"
)
...
normaliseCaMaterial() {
  local domain ca key
  for domain in banka.verity.local bankb.verity.local bb.verity.local frc.verity.local; do
