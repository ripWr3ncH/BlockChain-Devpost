 ...
 *
 *  So registration lands PENDING and Central Authority confirms. This panel is
 ...
 *  Central Authority's prior approval under the the Banking Act. Verity
...
export function BoardRoster({
  ...
  return (
    <div className="card">
      <h3>Your Board, as Central Authority sees it</h3>
      ...
      {pending > 0 && (
        <p className="hint">
          {pending} awaiting Central Authority. Signatures from those keys are refused with{' '}
...
export function BoardConfirmation({
  ...
  return (
    <div className="card">
      ...
      <p className="hint">
        Confirmation is a transaction, endorsed by the bank and by Central Authority, and it records
