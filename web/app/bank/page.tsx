 ...
 *   4. Directors sign. It commits, and the receipt shows Central Authority's
...
export default function BankPortal(): React.ReactNode {
  ...
  return (
    <>
      <h1>Bank officer</h1>
      <p className="sub">
        Every classification event carries the two signatures Regulation B para 11(c) already requires, and
            ...
            <div className="card" style={{ marginTop: '1rem' }}>
                  ...
                  <>
                    <p style={{ fontSize: '.87rem', margin: '0 0 .5rem' }}>
                      ...
                      {eventType === 'RESCHEDULE'
                        ? `RS-${nextRs} is a third or fourth rescheduling — Regulation A reserves it to the Board.`
                        ...
                        <label
                          ...
                          title={
                            isUsable(d)
                              ...
                              : 'registered by this bank, not yet confirmed by Central Authority'
                          }
                        >
                          <input
                            type="checkbox"
              ...
              <div className="row" style={{ marginTop: '1rem' }}>
                ...
                <span className="hint" style={{ margin: 0 }}>
                  requires endorsement from this bank&rsquo;s peer <em>and</em> Central Authority&rsquo;s
                </span>
              </div>
