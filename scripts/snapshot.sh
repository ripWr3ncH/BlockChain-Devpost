...
VOLUMES=(
  orderer0.ord-bb.verity.local orderer1.ord-bibm.verity.local orderer2.ord-frc.verity.local
  orderer3.ord-seata.verity.local orderer4.ord-seatb.verity.local
  peer0.banka.verity.local peer0.bankb.verity.local peer0.bb.verity.local peer0.frc.verity.local
)
